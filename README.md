...
```bash
cd /Users/bapimondal/stellarx
```

If you run commands outside this repository root, build fails because there is no Cargo.toml there.
...
```bash
cd /Users/bapimondal/stellarx/contracts/hello-world
make build
make test
```
...
![Testnet contract deployment screenshot](screenshot-testnet-deployment.png)
